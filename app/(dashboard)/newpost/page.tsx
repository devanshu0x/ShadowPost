...
export default function(){
  ...
  return (<div className="px-4 py-4 sm:px-8 ">
    ...
    <Input value={title} onChange={(e)=>setTitle(e.target.value)} placeholder="Enter title of thread here"/>
    <Label className="sm:text-lg mt-6 mb-2">Body</Label>
    <MilkdownEditorWrapper setValue={(value:string)=>(getMarkDown.current=value)}/>
    <Button onClick={async ()=>{
      await handlePublish();
      router.push("/dashboard");
    }} className="mt-4">Publish</Button>
    </div>
